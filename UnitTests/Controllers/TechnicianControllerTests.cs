...
{
    [TestClass]
    public class TechnicianControlerTests
    {
        #region IndexTests
        /// <summary>
        ...
        //             var myData = BiliWeb.Backend.BiliWeb.Backend.DataSourceBackend.Instance.Reset();.Instance.TechnicianBackend.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void Technician_Read_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new TechnicianController();
        ...
        /// </summary>
        [TestMethod]
        public void Technician_Delete_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new TechnicianController();
        ...
        /// </summary>
        [TestMethod]
        public void Technician_Delete_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new TechnicianController();
        ...
        [TestMethod]
        public void Technician_Delete_Get_Default_Should_Return_Error_Message()
        {
            // Arrange
            var controller = new TechnicianController();
        ...
        [TestMethod]
        public void Technician_Delete_Post_Null_Id_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new TechnicianController();
            TechnicianModel dataNull = new TechnicianModel
            {
                // Make data.Id = null
                ID = null
            };
