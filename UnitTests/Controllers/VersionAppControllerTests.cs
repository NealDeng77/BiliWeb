...
{
    [TestClass]
    public class VersionAppControlerTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Create_Get_Default_Should_Pass()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        {
            // Arrange
            var controller = new VersionAppController();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Read_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Read_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        //             var myData = BiliWeb.Backend.BiliWeb.Backend.DataSourceBackend.Instance.Reset();.Instance.VersionAppBackend.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Read_Get_InValid_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Read_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Update_Get_InValid_ID_Bogus_Should_Fail()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        [TestMethod]
        public void VersionApp_Update_Post_Invalid_Model_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new VersionAppController();
            var data = new VersionAppModel();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Update_Get_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new VersionAppController();
            var myData = BiliWeb.Backend.VersionAppBackend.Instance.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Update_Post_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new VersionAppController();
            var myData = BiliWeb.Backend.VersionAppBackend.Instance.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Delete_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Delete_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new VersionAppController();
        ...
        [TestMethod]
        public void VersionApp_Delete_Get_Null_Id_Should_Return_Error()
        {
            // Arrange
            var controller = new VersionAppController();
        ...
        [TestMethod]
        public void VersionApp_Delete_Invalid_Null_Data_Should_Return_Error()
        {
            // Arrange
            var controller = new VersionAppController();
            string id = "bogus";
        ...
        [TestMethod]
        public void VersionApp_Delete_Get_Default_Should_Pass()
        {
            // Arrange
            var controller = new VersionAppController();

            string id = BiliWeb.Backend.DataSourceBackend.Instance.VersionAppBackend.Index().FirstOrDefault().ID;
        ...
        [TestMethod]
        public void VersionApp_Delete_Get_Default_Should_Return_Error_Message()
        {
            // Arrange
            var controller = new VersionAppController();

            // Get default student
            var data = BiliWeb.Backend.DataSourceBackend.Instance.VersionAppBackend.Index().FirstOrDefault();
        ...
        [TestMethod]
        public void VersionApp_Delete_Get_Default_Should_Return_Data()
        {
            // Arrange
            var controller = new VersionAppController();
        ...
        [TestMethod]
        public void VersionApp_Delete_Post_Null_Data_Should_Return_Error()
        {
            // Arrange
            var controller = new VersionAppController();
        ...
        [TestMethod]
        public void VersionApp_Delete_Post_Null_Id_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new VersionAppController();
            VersionAppModel dataNull = new VersionAppModel
            {
                // Make data.Id = null
                ID = null
            };
        ...
        [TestMethod]
        public void VersionApp_Delete_Post_Empty_Id_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new VersionAppController();
            VersionAppModel dataEmpty = new VersionAppModel
            {
        ...
        [TestMethod]
        public void VersionApp_Delete_Post_Default_Should_Return_Index_Page()
        {
            // Arrange
            var controller = new VersionAppController();

            // Get default student
            var defaultData = BiliWeb.Backend.DataSourceBackend.Instance.VersionAppBackend.Index().FirstOrDefault();
            VersionAppModel data = new VersionAppModel(defaultData);
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Delete_Post_Valid_Should_Delete()
        {
            // Arrange
            var controller = new VersionAppController();
            ...
            var dataExist = BiliWeb.Backend.DataSourceBackend.Instance.VersionAppBackend.Read(data.ID);
