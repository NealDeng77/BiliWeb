...
namespace UnitTests.Controllers
{
    ...
    public class InventoryControllerTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Create_Get_Default_Should_Pass()
        {
            // Arrange
            var myController = new InventoryController();
        ...
        [TestMethod]
        public void Inventory_Create_Post_Invalid_Model_Should_Send_Back_For_Edit()
        {
            // Arrange
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Read_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new InventoryController();
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Read_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new InventoryController();
            var myData = BiliWeb.Backend.InventoryBackend.Instance.Index().FirstOrDefault();
        ...
        //             var myData = BiliWeb.Backend.BiliWeb.Backend.DataSourceBackend.Instance.Reset();.Instance.InventoryBackend.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Read_Get_InValid_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new InventoryController();
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Read_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new InventoryController();
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Update_Get_InValid_ID_Bogus_Should_Fail()
        {
            // Arrange
            var myController = new InventoryController();
        ...
        [TestMethod]
        public void Inventory_Update_Post_Invalid_Model_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new InventoryController();
            var data = new InventoryModel();
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Update_Get_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new InventoryController();
            var myData = BiliWeb.Backend.InventoryBackend.Instance.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Update_Post_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new InventoryController();
            var myData = BiliWeb.Backend.InventoryBackend.Instance.Index().FirstOrDefault();
            var resultData = new InventoryModel(myData)
            {
                ClinicID = "Clinic",
                TestStripStock = 99,
                ID = myData.ID
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Delete_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new InventoryController();
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Delete_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new InventoryController();
        ...
        [TestMethod]
        public void Inventory_Delete_Get_Null_Id_Should_Return_Error()
        {
            // Arrange
            var controller = new InventoryController();
        ...
        [TestMethod]
        public void Inventory_Delete_Invalid_Null_Data_Should_Return_Error()
        {
            // Arrange
            var controller = new InventoryController();
            string id = "bogus";
        ...
        [TestMethod]
        public void Inventory_Delete_Get_Default_Should_Return_Error_Message()
        {
            // Arrange
            var controller = new InventoryController();

            // Get default student
            var data = BiliWeb.Backend.DataSourceBackend.Instance.InventoryBackend.Index().FirstOrDefault();
        ...
        [TestMethod]
        public void Inventory_Delete_Get_Default_Should_Return_Data()
        {
            // Arrange
            var controller = new InventoryController();
        ...
        [TestMethod]
        public void Inventory_Delete_Post_Invalid_Model_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new InventoryController();
            var data = new InventoryModel();
        ...
        [TestMethod]
        public void Inventory_Delete_Post_Null_Data_Should_Return_Error()
        {
            // Arrange
            var controller = new InventoryController();
        ...
        [TestMethod]
        public void Inventory_Delete_Post_Null_Id_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new InventoryController();
            InventoryModel dataNull = new InventoryModel
            {
                // Make data.Id = null
                ID = null
            };
        ...
        [TestMethod]
        public void Inventory_Delete_Post_Empty_Id_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new InventoryController();
            InventoryModel dataEmpty = new InventoryModel
            {
        ...
        [TestMethod]
        public void Inventory_Delete_Post_Default_Should_Return_Index_Page()
        {
            // Arrange
            var controller = new InventoryController();

            // Get default student
            var defaultData = BiliWeb.Backend.DataSourceBackend.Instance.InventoryBackend.Index().FirstOrDefault();
            InventoryModel data = new InventoryModel(defaultData);
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Delete_Post_Valid_Should_Delete()
        {
            // Arrange
            var controller = new InventoryController();
            ...
            var dataExist = BiliWeb.Backend.DataSourceBackend.Instance.InventoryBackend.Read(data.ID);
