...
{
    [TestClass]
    public class HistoryAppControlerTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Create_Get_Default_Should_Pass()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Read_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Read_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        //             var myData = BiliWeb.Backend.BiliWeb.Backend.DataSourceBackend.Instance.Reset();.Instance.HistoryAppBackend.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Read_Get_InValid_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Read_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Update_Get_InValid_ID_Bogus_Should_Fail()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Update_Get_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new HistoryAppController();
            var myData = BiliWeb.Backend.HistoryAppBackend.Instance.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Delete_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Delete_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new HistoryAppController();
        ...
        [TestMethod]
        public void HistoryApp_Delete_Get_Null_Id_Should_Return_Error()
        {
            // Arrange
            var controller = new HistoryAppController();
        ...
        [TestMethod]
        public void HistoryApp_Delete_Invalid_Null_Data_Should_Return_Error()
        {
            // Arrange
            var controller = new HistoryAppController();
            string id = "bogus";
        ...
        [TestMethod]
        public void HistoryApp_Delete_Get_Default_Should_Pass()
        {
            // Arrange
            var controller = new HistoryAppController();

            string id = BiliWeb.Backend.DataSourceBackend.Instance.HistoryAppBackend.Index().FirstOrDefault().ID;
        ...
        [TestMethod]
        public void HistoryApp_Delete_Get_Default_Should_Return_Error_Message()
        {
            // Arrange
            var controller = new HistoryAppController();

            // Get default student
            var data = BiliWeb.Backend.DataSourceBackend.Instance.HistoryAppBackend.Index().FirstOrDefault();
        ...
        [TestMethod]
        public void HistoryApp_Delete_Get_Default_Should_Return_Data()
        {
            // Arrange
            var controller = new HistoryAppController();
        ...
        [TestMethod]
        public void HistoryApp_Delete_Post_Null_Data_Should_Return_Error()
        {
            // Arrange
            var controller = new HistoryAppController();
        ...
        [TestMethod]
        public void HistoryApp_Delete_Post_Null_Id_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new HistoryAppController();
            HistoryAppModel dataNull = new HistoryAppModel
            {
                // Make data.Id = null
                ID = null
            };
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Delete_Post_Valid_Should_Delete()
        {
            // Arrange
            var controller = new HistoryAppController();
            ...
            var dataExist = BiliWeb.Backend.DataSourceBackend.Instance.HistoryAppBackend.Read(data.ID);
