...
{
    [TestClass]
    public class PhotoControlerTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Create_Get_Default_Should_Pass()
        {
            // Arrange
            var myController = new PhotoController();
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Read_Get_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new PhotoController();
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Read_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new PhotoController();
            var myData = BiliWeb.Backend.PhotoBackend.Instance.Index().FirstOrDefault();
        ...
        //             var myData = BiliWeb.Backend.BiliWeb.Backend.DataSourceBackend.Instance.Reset();.Instance.PhotoBackend.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Read_Get_InValid_Data_Null_Should_Fail()
        {
            // Arrange
            var myController = new PhotoController();
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Read_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new PhotoController();
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Update_Get_InValid_ID_Bogus_Should_Fail()
        {
            // Arrange
            var myController = new PhotoController();
        ...
        [TestMethod]
        public void Photo_Update_Post_Invalid_Model_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new PhotoController();
            var data = new PhotoModel();
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Update_Get_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new PhotoController();
            var myData = BiliWeb.Backend.PhotoBackend.Instance.Index().FirstOrDefault();
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Update_Post_Valid_Data_Should_Pass()
        {
            // Arrange
            var myController = new PhotoController();
            var myData = BiliWeb.Backend.PhotoBackend.Instance.Index().FirstOrDefault();
            var resultData = new PhotoModel(myData)
            {
                Note = "New",
                ID = myData.ID
            };
        ...
        /// </summary>
        [TestMethod]
        public void Photo_Delete_Get_Data_In_Valid_Should_Fail()
        {
            // Arrange
            var myController = new PhotoController();
        ...
        [TestMethod]
        public void Photo_Delete_Get_Default_Should_Return_Error_Message()
        {
            // Arrange
            var controller = new PhotoController();
        ...
        [TestMethod]
        public void Photo_Delete_Post_Null_Id_Should_Send_Back_For_Edit()
        {
            // Arrange
            var controller = new PhotoController();
            PhotoModel dataNull = new PhotoModel
            {
                // Make data.Id = null
                ID = null
            };
