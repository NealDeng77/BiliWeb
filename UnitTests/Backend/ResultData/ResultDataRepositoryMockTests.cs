...
{
    [TestClass]
    public class ResultDataRepositoryMockTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void ResultData_Read_Get_Data_InValid_Empty_Should_Fail()
        {
            // Arrange
            var myBackend = ResultDataRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void ResultData_BackupData_Data_Valid_Should_Pass()
        {
            // Arrange
            var myBackend = ResultDataRepositoryMock.Instance;
