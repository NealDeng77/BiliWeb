...
{
    [TestClass]
    public class ResultDataRepositoryStoreTests
    {
        #region IndexTests
        /// <summary>
        ...
        public void ResultData_Update_Default_Should_Pass()
        {
            ...
            myDataCopy.ResultCode = "ResultCode3";
            ...
            // Assert
            Assert.AreEqual("ResultCode3", result.ResultCode);
        }
        ...
        /// </summary>
        [TestMethod]
        public void ResultData_Update_InValid_Null_Should_Fail()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = DataSourceBackend.Instance.ResultDataBackend;
        ...
        /// </summary>
        [TestMethod]
        public void ResultData_GetDataSourceString_Data_Valid_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = DataSourceBackend.Instance.ResultDataBackend;
        ...
        /// </summary>
        [TestMethod]
        public void ResultData_LoadDataSet_Valid_Default_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ResultDataRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void ResultData_LoadDataSet_Valid_UnitTest_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ResultDataRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void ResultData_LoadDataSet_Valid_Demo_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ResultDataRepositoryStore.Instance;
