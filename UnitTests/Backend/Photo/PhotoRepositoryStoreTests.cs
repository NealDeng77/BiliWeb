...
{
    [TestClass]
    public class PhotoRepositoryStoreTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void Photo_LoadDataSet_Valid_Default_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
        ...
        /// </summary>
        [TestMethod]
        public void Photo_LoadDataSet_Valid_UnitTest_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = PhotoRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Photo_LoadDataSet_Valid_Demo_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = PhotoRepositoryStore.Instance;
