...
{
    [TestClass]
    public class VersionAppRepositoryMockTests
    {
        #region IndexTests
        /// <summary>
        ...
        {
            // Arrange
            var myBackend = VersionAppRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_Read_Get_Data_InValid_Empty_Should_Fail()
        {
            // Arrange
            var myBackend = VersionAppRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void VersionApp_BackupData_Data_Valid_Should_Pass()
        {
            // Arrange
            var myBackend = VersionAppRepositoryMock.Instance;
