...
{
    [TestClass]
    public class VersionOSRepositoryMockTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_Read_Get_Data_InValid_Empty_Should_Fail()
        {
            // Arrange
            var myBackend = VersionOSRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_BackupData_Data_Valid_Should_Pass()
        {
            // Arrange
            var myBackend = VersionOSRepositoryMock.Instance;
