...
{
    [TestClass]
    public class VersionOSHelperTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void VersionOSHelper_ConvertIDtoString_InValid_Null_Should_Fail()
        {
            // Arrange

            // Act
            var result = VersionOSHelper.ConvertIDtoString(null);
        ...
        /// </summary>
        [TestMethod]
        public void VersionOSHelper_ConvertIDtoString_InValid_Bogus_Should_Fail()
        {
            // Arrange

            // Act
            var result = VersionOSHelper.ConvertIDtoString("bogus");
        ...
        /// <summary>
        /// Returns a set of Select List Items from the data set of VersionOS
        /// Used for converting the records to a list that can go into a drop down list box
        /// </summary>
        [TestMethod]
        public void VersionOSHelper_ToSelectListItemsTests_Valid_Should_Pass()
        {
            // Arrange
            var data = DataSourceBackend.Instance.VersionOSBackend.Index();

            // Act
            var result = VersionOSHelper.ToSelectListItems(data,null);
            ...
            {
                Assert.AreEqual(item.Text, data.Find(m=>m.ID==item.Value).VersionOSName);
            }
        ...
        /// </summary>
        [TestMethod]
        public void VersionOSHelper_ToSelectListItemsTests_Valid_Selected_Should_Pass()
        {
            // Arrange
            var data = DataSourceBackend.Instance.VersionOSBackend.Index();
            ...
            // Act
            var result = VersionOSHelper.ToSelectListItems(data, value);
        ...
        /// </summary>
        [TestMethod]
        public void VersionOSHelper_ToSelectListItemsTests_InValid_Selected_Should_Pass()
        {
            // Arrange
            var data = DataSourceBackend.Instance.VersionOSBackend.Index();
