...
{
    [TestClass]
    public class VersionOSBackendTests
    {
        #region IndexTests
        /// <summary>
        ...
        public void VersionOS_Update_Post_Default_Should_Pass()
        {
            ...
            // Assert
            Assert.AreEqual("New",result.VersionOSName);
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_SetDataSource_Data_Mock_Should_Pass()
        {
            // Arrange
            var myBackend = VersionOSBackend.Instance;
            var dataOriginal = myBackend.Index().FirstOrDefault();
            ...
            // Act
            VersionOSBackend.SetDataSource(DataSourceEnum.Mock);
            var result = VersionOSBackend.Instance.GetDataSourceString();
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_SetDataSource_Data_Local_Should_Pass()
        {
            // Arrange
            var myBackend = VersionOSBackend.Instance;
            var dataOriginal = myBackend.Index().FirstOrDefault();
            ...
            // Act
            VersionOSBackend.SetDataSource(DataSourceEnum.Local);
            var result = VersionOSBackend.Instance.GetDataSourceString();
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_SetDataSourceSet_Data_Local_Should_Pass()
        {
            // Arrange
            var myBackend = VersionOSBackend.Instance;
            var dataOriginal = myBackend.Index().FirstOrDefault();
            ...
            // Act
            VersionOSBackend.SetDataSourceDataSet(DataSourceDataSetEnum.Default);
