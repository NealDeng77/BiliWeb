...
namespace UnitTests.Backend
{
    ...
    public class VersionOSRepositoryStoreTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_LoadDataSet_Valid_Default_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_LoadDataSet_Valid_UnitTest_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = VersionOSRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void VersionOS_LoadDataSet_Valid_Demo_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = VersionOSRepositoryStore.Instance;
