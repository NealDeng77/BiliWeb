...
{
    [TestClass]
    public class HistoryOSBackendTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOS_Update_Post_Default_Should_Pass()
        {
            // Arrange
            var myBackend = HistoryOSBackend.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOS_SetDataSource_Data_Mock_Should_Pass()
        {
            // Arrange
            var myBackend = HistoryOSBackend.Instance;
            var dataOriginal = myBackend.Index().FirstOrDefault();
            ...
            // Act
            HistoryOSBackend.SetDataSource(DataSourceEnum.Mock);
            var result = HistoryOSBackend.Instance.GetDataSourceString();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOS_SetDataSource_Data_Local_Should_Pass()
        {
            // Arrange
            var myBackend = HistoryOSBackend.Instance;
            var dataOriginal = myBackend.Index().FirstOrDefault();
            ...
            // Act
            HistoryOSBackend.SetDataSource(DataSourceEnum.Local);
            var result = HistoryOSBackend.Instance.GetDataSourceString();
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOS_SetDataSourceSet_Data_Local_Should_Pass()
        {
            // Arrange
            var myBackend = HistoryOSBackend.Instance;
            var dataOriginal = myBackend.Index().FirstOrDefault();
            ...
            // Act
            HistoryOSBackend.SetDataSourceDataSet(DataSourceDataSetEnum.Default);
