...
{
    [TestClass]
    public class HistoryOSHelperTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOSHelper_ConvertIDtoString_InValid_Null_Should_Fail()
        {
            // Arrange

            // Act
            var result = HistoryOSHelper.ConvertIDtoString(null);
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOSHelper_ConvertIDtoString_InValid_Bogus_Should_Fail()
        {
            // Arrange

            // Act
            var result = HistoryOSHelper.ConvertIDtoString("bogus");
        ...
        /// <summary>
        /// Returns a set of Select List Items from the data set of HistoryOS
