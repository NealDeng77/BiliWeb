...
{
    [TestClass]
    public class HistoryOSRepositoryMockTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOS_Read_Get_Data_InValid_Empty_Should_Fail()
        {
            // Arrange
            var myBackend = HistoryOSRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void HistoryOS_BackupData_Data_Valid_Should_Pass()
        {
            // Arrange
            var myBackend = HistoryOSRepositoryMock.Instance;
