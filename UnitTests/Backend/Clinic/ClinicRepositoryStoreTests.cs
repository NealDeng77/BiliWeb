...
namespace UnitTests.Backend
{
    ...
    public class ClinicRepositoryStoreTests
    {
        ...
        public void Clinic_Index_Get_Default_Should_Pass()
        {
            ...
            var myBackend = DataSourceBackend.Instance.ClinicBackend;
        ...
        /// </summary>
        [TestMethod]
        public void Clinic_LoadDataSet_Valid_Default_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ClinicRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Clinic_LoadDataSet_Valid_UnitTest_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ClinicRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Clinic_LoadDataSet_Valid_Demo_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ClinicRepositoryStore.Instance;
