...
namespace UnitTests.Backend
{
    ...
    public class HistoryAppRepositoryStoreTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_LoadDataSet_Valid_Default_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_LoadDataSet_Valid_UnitTest_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = HistoryAppRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_LoadDataSet_Valid_Demo_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = HistoryAppRepositoryStore.Instance;
