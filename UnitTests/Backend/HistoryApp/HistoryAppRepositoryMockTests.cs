...
{
    [TestClass]
    public class HistoryAppRepositoryMockTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_Read_Get_Data_InValid_Empty_Should_Fail()
        {
            // Arrange
            var myBackend = HistoryAppRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void HistoryApp_BackupData_Data_Valid_Should_Pass()
        {
            // Arrange
            var myBackend = HistoryAppRepositoryMock.Instance;
