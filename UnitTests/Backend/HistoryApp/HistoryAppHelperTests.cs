...
{
    [TestClass]
    public class HistoryAppHelperTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void HistoryAppHelper_ConvertIDtoString_InValid_Null_Should_Fail()
        {
            // Arrange

            // Act
            var result = HistoryAppHelper.ConvertIDtoString(null);
        ...
        /// </summary>
        [TestMethod]
        public void HistoryAppHelper_ConvertIDtoString_InValid_Bogus_Should_Fail()
        {
            // Arrange

            // Act
            var result = HistoryAppHelper.ConvertIDtoString("bogus");
        ...
        /// <summary>
        /// Returns a set of Select List Items from the data set of HistoryApp
        /// Used for converting the records to a list that can go into a drop down list box
        /// </summary>
        [TestMethod]
        public void HistoryAppHelper_ToSelectListItemsTests_Valid_Should_Pass()
        {
            // Arrange
            var data = DataSourceBackend.Instance.HistoryAppBackend.Index();

            // Act
            var result = HistoryAppHelper.ToSelectListItems(data,null);
        ...
        /// </summary>
        [TestMethod]
        public void HistoryAppHelper_ToSelectListItemsTests_Valid_Selected_Should_Pass()
        {
            // Arrange
            var data = DataSourceBackend.Instance.HistoryAppBackend.Index();
            ...
            // Act
            var result = HistoryAppHelper.ToSelectListItems(data, value);
        ...
        /// </summary>
        [TestMethod]
        public void HistoryAppHelper_ToSelectListItemsTests_InValid_Selected_Should_Pass()
        {
            // Arrange
            var data = DataSourceBackend.Instance.HistoryAppBackend.Index();
