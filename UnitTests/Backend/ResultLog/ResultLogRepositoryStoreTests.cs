...
namespace UnitTests.Backend
{
    ...
    public class ResultLogRepositoryStoreTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void ResultLog_LoadDataSet_Valid_Default_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ResultLogRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void ResultLog_LoadDataSet_Valid_UnitTest_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ResultLogRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void ResultLog_LoadDataSet_Valid_Demo_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = ResultLogRepositoryStore.Instance;
