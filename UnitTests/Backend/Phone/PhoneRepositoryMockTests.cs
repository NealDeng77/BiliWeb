...
{
    [TestClass]
    public class PhoneRepositoryMockTests
    {
        #region IndexTests
        /// <summary>
        ...
        {
            // Arrange
            var myBackend = PhoneRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Phone_Read_Get_Data_InValid_Empty_Should_Fail()
        {
            // Arrange
            var myBackend = PhoneRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Phone_BackupData_Data_Valid_Should_Pass()
        {
            // Arrange
            var myBackend = PhoneRepositoryMock.Instance;
