...
{
    [TestClass]
    public class TechnicianRepositoryStoreTests
    {
        #region IndexTests
        /// <summary>
        ...
        public void Technician_Index_Get_Default_Should_Pass()
        {
            ...
            var myBackend = DataSourceBackend.Instance.TechnicianBackend;
        ...
        /// </summary>
        [TestMethod]
        public void Technician_LoadDataSet_Valid_Default_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = TechnicianRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Technician_LoadDataSet_Valid_UnitTest_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = TechnicianRepositoryStore.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Technician_LoadDataSet_Valid_Demo_Should_Pass()
        {
            // Arrange
            DataSourceBackend.Instance.SetDataSource(DataSourceEnum.Local);
            var myBackend = TechnicianRepositoryStore.Instance;
