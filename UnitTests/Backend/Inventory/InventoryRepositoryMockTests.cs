...
{
    [TestClass]
    public class InventoryRepositoryMockTests
    {
        #region IndexTests
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_Read_Get_Data_InValid_Empty_Should_Fail()
        {
            // Arrange
            var myBackend = InventoryRepositoryMock.Instance;
        ...
        /// </summary>
        [TestMethod]
        public void Inventory_BackupData_Data_Valid_Should_Pass()
        {
            // Arrange
            var myBackend = InventoryRepositoryMock.Instance;
