...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class PhoneRepositoryStore : IPhoneRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile PhoneRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private PhoneRepositoryStore() { }

        public static PhoneRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new PhoneRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<PhoneModel> dataset = new List<PhoneModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "PhoneModel";
        ...
        public PhoneModel Create(PhoneModel data, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            if (data == null)
            {
                return null;
            ...
            // Add to Storage
            var myResult = DataSourceBackendTable.Instance.Create<PhoneModel>(tableName, partitionKey, data.ID, data, dataSourceEnum);
        ...
        public PhoneModel Read(string id)
        {
        ...
        public PhoneModel Update(PhoneModel data)
        {
            if (data == null)
            {
                return null;
            ...
            // Update Storage
            var myResult = DataSourceBackendTable.Instance.Create<PhoneModel>(tableName, partitionKey, data.ID, data);
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<PhoneModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        /// <returns></returns>
        public List<PhoneModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<PhoneModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = PhoneRepositoryDataHelper.Instance.GetDefaultDataSet();
