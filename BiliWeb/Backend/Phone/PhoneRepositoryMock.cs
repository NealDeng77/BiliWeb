...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class PhoneRepositoryMock : IPhoneRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile PhoneRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private PhoneRepositoryMock() { }

        public static PhoneRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new PhoneRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
