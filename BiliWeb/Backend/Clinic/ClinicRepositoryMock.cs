...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class ClinicRepositoryMock : IClinicRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile ClinicRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private ClinicRepositoryMock() { }

        public static ClinicRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new ClinicRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
