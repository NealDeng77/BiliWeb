...
namespace BiliWeb.Backend
{
    public static class ClinicHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static IEnumerable<SelectListItem> ToSelectListItems(this IEnumerable<ClinicModel> dataSet, string selectedId)
        {
            return
        ...
        {
            var data = DataSourceBackend.Instance.ClinicBackend.Read(id);
            if (data == null)
            {
                return string.Empty;
            }
