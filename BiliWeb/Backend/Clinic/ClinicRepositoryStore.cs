...
{
    /// <summary>
    /// In Memory Implementation of a Clinic data store
    /// </summary>
    public class ClinicRepositoryStore : IClinicRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile ClinicRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private ClinicRepositoryStore() { }

        public static ClinicRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new ClinicRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<ClinicModel> dataset = new List<ClinicModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "ClinicModel";
        ...
        public ClinicModel Update(ClinicModel data)
        {
            ...
            // Update Storage
            var myResult = DataSourceBackendTable.Instance.Create<ClinicModel>(tableName, partitionKey, data.ID, data);
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<ClinicModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        /// <returns></returns>
        public List<ClinicModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<ClinicModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = ClinicRepositoryDataHelper.Instance.GetDefaultDataSet();
...
/// <summary>
/// Add the Clinic item to the data store
/// </summary>
/// <param name="data">
/// The new Clinic item to add to the data store
/// </param>
/// <returns>return the passed in Clinic item</returns>
public ClinicModel Create(ClinicModel data)
        ...
        /// <summary>
        /// Return the requested Clinic item from the data store
