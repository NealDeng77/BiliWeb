...
{
    public class TechnicianBackend
    {
        #region SingletonPattern
        private static volatile TechnicianBackend instance;
        private static object syncRoot = new object();

        private TechnicianBackend() { }

        public static TechnicianBackend Instance
        {
            get
            {
                if (instance == null)
                {
                    ...
                    {
                        if (instance == null)
                            instance = new TechnicianBackend();
                    }
                }
        ...
        private static ITechnicianRepository repository = TechnicianRepositoryMock.Instance;
        ...
        /// </summary>
        /// <returns>The list of Technicians.</returns>
