...
namespace BiliWeb.Backend
{
    public static class TechnicianHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static IEnumerable<SelectListItem> ToSelectListItems(this IEnumerable<TechnicianModel> dataSet, string selectedId)
        {
            return
        ...
        /// For Technician converts id 234-asdf-234-sdf to "Bellevue"
        /// </summary>
        ...
        {
            var data = DataSourceBackend.Instance.TechnicianBackend.Read(id);
            if (data == null)
            {
                return string.Empty;
            }
