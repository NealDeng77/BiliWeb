...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class TechnicianRepositoryStore : ITechnicianRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile TechnicianRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private TechnicianRepositoryStore() { }

        public static TechnicianRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new TechnicianRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        public const string ClassName = "TechnicianModel";
        ...
        public TechnicianModel Update(TechnicianModel data)
        {
            ...
            // Update Storage
            var myResult = DataSourceBackendTable.Instance.Create<TechnicianModel>(tableName, partitionKey, data.ID, data);
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<TechnicianModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        /// <returns></returns>
        public List<TechnicianModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<TechnicianModel>(tableName, partitionKey, true, dataSourceEnum);
...
public TechnicianModel Create(TechnicianModel data)
        {
            if (data == null)
            {
                return null;
