...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class VersionAppRepositoryMock : IVersionAppRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile VersionAppRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private VersionAppRepositoryMock() { }

        public static VersionAppRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new VersionAppRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
