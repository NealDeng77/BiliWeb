...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class VersionAppRepositoryStore : IVersionAppRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile VersionAppRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private VersionAppRepositoryStore() { }

        public static VersionAppRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new VersionAppRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<VersionAppModel> dataset = new List<VersionAppModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "VersionAppModel";
        ...
        public VersionAppModel Create(VersionAppModel data, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Add to Storage
            var myResult = DataSourceBackendTable.Instance.Create<VersionAppModel>(tableName, partitionKey, data.ID, data, dataSourceEnum);
        ...
        public VersionAppModel Update(VersionAppModel data)
        {
            ...
            // Update Storage
            var myResult = DataSourceBackendTable.Instance.Create<VersionAppModel>(tableName, partitionKey, data.ID, data);
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<VersionAppModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        /// <returns></returns>
        public List<VersionAppModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<VersionAppModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = VersionAppRepositoryDataHelper.Instance.GetDefaultDataSet();
...
public VersionAppModel Create(VersionAppModel data)
        ...
        /// <summary>
        /// Return the requested VersionApp item from the data store
