...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class VersionOSRepositoryMock : IVersionOSRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile VersionOSRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private VersionOSRepositoryMock() { }

        public static VersionOSRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new VersionOSRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
