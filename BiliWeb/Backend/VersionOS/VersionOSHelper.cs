...
{
    public static class VersionOSHelper
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static IEnumerable<SelectListItem> ToSelectListItems(this IEnumerable<VersionOSModel> dataSet, string selectedId)
        {
            return
                dataSet.OrderBy(m => m.ID)
                      .Select(m =>
                          new SelectListItem
                          {
                              ...
                              Text = m.VersionOSName
                          });
        }

        /// <summary>
        /// Converts the ID for a record, to a string for the item.
        /// For VersionOS converts id 234-asdf-234-sdf to "Bellevue"
        /// </summary>
        ...
        {
            var data = DataSourceBackend.Instance.VersionOSBackend.Read(id);
            if (data == null)
            {
                return string.Empty;
            }
