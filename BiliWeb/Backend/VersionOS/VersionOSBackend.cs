...
{
    public class VersionOSBackend
    {
        #region SingletonPattern
        private static volatile VersionOSBackend instance;
        private static object syncRoot = new object();

        private VersionOSBackend() { }

        public static VersionOSBackend Instance
        {
            get
            {
                if (instance == null)
        ...
        private static IVersionOSRepository repository = VersionOSRepositoryMock.Instance;
        ...
        public static void SetDataSource(DataSourceEnum dataSourceEnum)
        {
            switch (dataSourceEnum)
            {
                ...
                case DataSourceEnum.ServerTest:
                    ...
                    repository = VersionOSRepositoryStore.Instance;
                    break;
                ...
                default:
                    ...
                    repository = VersionOSRepositoryMock.Instance;
                    break;
            }
        ...
        /// <summary>
        ///  Returns the List of VersionOSs
        /// </summary>
        /// <returns>The list of VersionOSs.</returns>
