...
{
    /// <summary>
    /// In Memory Implementation of a VersionOS data store
    /// </summary>
    public class VersionOSRepositoryStore : IVersionOSRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile VersionOSRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private VersionOSRepositoryStore() { }

        public static VersionOSRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new VersionOSRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<VersionOSModel> dataset = new List<VersionOSModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "VersionOSModel";
        ...
        public VersionOSModel Read(string id)
        {
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<VersionOSModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        public List<VersionOSModel> Index()
        {
            return dataset;
        }
        ...
        /// <returns></returns>
        public List<VersionOSModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<VersionOSModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = VersionOSRepositoryDataHelper.Instance.GetDefaultDataSet();
...
public VersionOSModel Create(VersionOSModel data)
        {
            if (data == null)
            {
                return null;
        ...
        /// <summary>
        /// Return the requested VersionOS item from the data store
