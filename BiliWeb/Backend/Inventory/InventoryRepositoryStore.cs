...
{
    /// <summary>
    /// In Memory Implementation of a Inventory data store
    /// </summary>
    public class InventoryRepositoryStore : IInventoryRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile InventoryRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private InventoryRepositoryStore() { }

        public static InventoryRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new InventoryRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<InventoryModel> dataset = new List<InventoryModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "InventoryModel";
        ...
        public InventoryModel Create(InventoryModel data, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            if (data == null)
            {
                return null;
            ...
            // Add to Storage
            var myResult = DataSourceBackendTable.Instance.Create<InventoryModel>(tableName, partitionKey, data.ID, data, dataSourceEnum);
        ...
        public InventoryModel Read(string id)
        {
        ...
        public InventoryModel Update(InventoryModel data)
        {
            if (data == null)
            {
                return null;
            ...
            // Update Storage
            var myResult = DataSourceBackendTable.Instance.Create<InventoryModel>(tableName, partitionKey, data.ID, data);
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<InventoryModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        public List<InventoryModel> Index()
        {
            return dataset;
        }
        ...
        /// <returns></returns>
        public List<InventoryModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<InventoryModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = InventoryRepositoryDataHelper.Instance.GetDefaultDataSet();
...
/// <summary>
/// Add the Inventory item to the data store
/// </summary>
/// <param name="data">
/// The new Inventory item to add to the data store
/// </param>
/// <returns>return the passed in Inventory item</returns>
public InventoryModel Create(InventoryModel data)
        ...
        /// <summary>
        /// Return the requested Inventory item from the data store
