...
namespace BiliWeb.Backend
{
    public class InventoryBackend
    {
        ...
        private static volatile InventoryBackend instance;
        ...
        private static IInventoryRepository repository = InventoryRepositoryMock.Instance;
        ...
        public static void SetDataSource(DataSourceEnum dataSourceEnum)
        {
            switch (dataSourceEnum)
            {
                ...
                case DataSourceEnum.ServerTest:
                    ...
                    repository = InventoryRepositoryStore.Instance;
                    break;
                ...
                default:
                    ...
                    repository = InventoryRepositoryMock.Instance;
                    break;
            }
        ...
        /// </summary>
        /// <returns>The list of Inventorys.</returns>
