...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class HistoryAppRepositoryMock : IHistoryAppRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile HistoryAppRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private HistoryAppRepositoryMock() { }

        public static HistoryAppRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new HistoryAppRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
