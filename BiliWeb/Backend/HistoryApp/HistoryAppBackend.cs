...
{
    public class HistoryAppBackend
    {
        #region SingletonPattern
        private static volatile HistoryAppBackend instance;
        private static object syncRoot = new object();

        private HistoryAppBackend() { }

        public static HistoryAppBackend Instance
        {
            get
            {
                if (instance == null)
                {
                    ...
                    {
                        if (instance == null)
                            instance = new HistoryAppBackend();
                    }
                }
        ...
        private static IHistoryAppRepository repository = HistoryAppRepositoryMock.Instance;
        ...
        public static void SetDataSource(DataSourceEnum dataSourceEnum)
        {
            switch (dataSourceEnum)
            {
                ...
                case DataSourceEnum.ServerTest:
                    ...
                    repository = HistoryAppRepositoryStore.Instance;
                    break;
                ...
                default:
                    ...
                    repository = HistoryAppRepositoryMock.Instance;
                    break;
            }
        ...
        /// <summary>
        ///  Returns the List of HistoryApps
        /// </summary>
        /// <returns>The list of HistoryApps.</returns>
