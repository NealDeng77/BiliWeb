...
{
    /// <summary>
    /// In Memory Implementation of a HistoryApp data store
    /// </summary>
    public class HistoryAppRepositoryStore : IHistoryAppRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile HistoryAppRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private HistoryAppRepositoryStore() { }

        public static HistoryAppRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new HistoryAppRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<HistoryAppModel> dataset = new List<HistoryAppModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "HistoryAppModel";
        ...
        public HistoryAppModel Read(string id)
        {
        ...
        public List<HistoryAppModel> Index()
        {
            return dataset;
        }
        ...
        /// <returns></returns>
        public List<HistoryAppModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<HistoryAppModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = HistoryAppRepositoryDataHelper.Instance.GetDefaultDataSet();
...
public HistoryAppModel Create(HistoryAppModel data)
        {
            if (data == null)
            {
                return null;
        ...
        /// <summary>
        /// Return the requested HistoryApp item from the data store
