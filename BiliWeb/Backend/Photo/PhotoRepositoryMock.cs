...
namespace BiliWeb.Backend
{
    ...
    public class PhotoRepositoryMock : IPhotoRepository
    {
        ...
        /// </summary>
        private static volatile PhotoRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private PhotoRepositoryMock() { }

        public static PhotoRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new PhotoRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
