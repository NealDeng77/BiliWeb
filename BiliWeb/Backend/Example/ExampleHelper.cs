...
namespace BiliWeb.Backend
{
    public static class ExampleHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static IEnumerable<SelectListItem> ToSelectListItems(this IEnumerable<ExampleModel> dataSet, string selectedId)
        {
            return
        ...
        {
            var data = DataSourceBackend.Instance.ExampleBackend.Read(id);
            if (data == null)
            {
                return string.Empty;
            }
