...
{
    public class ResultDataBackend
    {
        #region SingletonPattern
        private static volatile ResultDataBackend instance;
        private static object syncRoot = new object();

        private ResultDataBackend() { }

        public static ResultDataBackend Instance
        {
            get
            {
                if (instance == null)
                {
                    ...
                    {
                        if (instance == null)
                            instance = new ResultDataBackend();
                    }
                }
        ...
        private static IResultDataRepository repository = ResultDataRepositoryMock.Instance;
        ...
        public static void SetDataSource(DataSourceEnum dataSourceEnum)
        {
            switch (dataSourceEnum)
            {
                ...
                case DataSourceEnum.ServerTest:
                    ...
                    repository = ResultDataRepositoryStore.Instance;
                    break;
                ...
                default:
                    ...
                    repository = ResultDataRepositoryMock.Instance;
                    break;
            }
        ...
        /// <summary>
        ///  Returns the List of ResultDatas
        /// </summary>
        /// <returns>The list of ResultDatas.</returns>
