...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class ResultDataRepositoryStore : IResultDataRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile ResultDataRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private ResultDataRepositoryStore() { }

        public static ResultDataRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new ResultDataRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        public const string ClassName = "ResultDataModel";
        ...
        public ResultDataModel Update(ResultDataModel data)
        {
            ...
            // Update Storage
            var myResult = DataSourceBackendTable.Instance.Create<ResultDataModel>(tableName, partitionKey, data.ID, data);
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<ResultDataModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        /// <returns></returns>
        public List<ResultDataModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<ResultDataModel>(tableName, partitionKey, true, dataSourceEnum);
...
public ResultDataModel Create(ResultDataModel data)
        {
            if (data == null)
            {
                return null;
