...
{
    /// <summary>
    /// In Memory Implementation of a ResultLog data store
    /// </summary>
    public class ResultLogRepositoryStore : IResultLogRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile ResultLogRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private ResultLogRepositoryStore() { }

        public static ResultLogRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new ResultLogRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<ResultLogModel> dataset = new List<ResultLogModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "ResultLogModel";
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<ResultLogModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        /// <returns></returns>
        public List<ResultLogModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<ResultLogModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = ResultLogRepositoryDataHelper.Instance.GetDefaultDataSet();
...
public ResultLogModel Create(ResultLogModel data)
        ...
        /// <summary>
        /// Return the requested ResultLog item from the data store
