...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class ResultLogRepositoryMock : IResultLogRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile ResultLogRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private ResultLogRepositoryMock() { }

        public static ResultLogRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new ResultLogRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
