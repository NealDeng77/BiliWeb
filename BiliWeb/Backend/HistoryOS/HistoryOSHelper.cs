...
{
    public static class HistoryOSHelper
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static IEnumerable<SelectListItem> ToSelectListItems(this IEnumerable<HistoryOSModel> dataSet, string selectedId)
        {
            return
        ...
        /// For HistoryOS converts id 234-asdf-234-sdf to "Bellevue"
        /// </summary>
        ...
        {
            var data = DataSourceBackend.Instance.HistoryOSBackend.Read(id);
            if (data == null)
            {
                return string.Empty;
            }
