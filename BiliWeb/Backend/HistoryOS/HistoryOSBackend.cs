...
{
    public class HistoryOSBackend
    {
        #region SingletonPattern
        private static volatile HistoryOSBackend instance;
        private static object syncRoot = new object();

        private HistoryOSBackend() { }

        public static HistoryOSBackend Instance
        {
            get
            {
                if (instance == null)
        ...
        private static IHistoryOSRepository repository = HistoryOSRepositoryMock.Instance;
        ...
        public static void SetDataSource(DataSourceEnum dataSourceEnum)
        {
            switch (dataSourceEnum)
            {
                ...
                case DataSourceEnum.ServerTest:
                    ...
                    repository = HistoryOSRepositoryStore.Instance;
                    break;
                ...
                default:
                    ...
                    repository = HistoryOSRepositoryMock.Instance;
                    break;
            }
        ...
        /// <summary>
        ///  Returns the List of HistoryOSs
        /// </summary>
        /// <returns>The list of HistoryOSs.</returns>
