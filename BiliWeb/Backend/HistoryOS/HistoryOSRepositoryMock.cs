...
namespace BiliWeb.Backend
{
    ...
    /// </summary>
    public class HistoryOSRepositoryMock : IHistoryOSRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile HistoryOSRepositoryMock instance;
        private static readonly object syncRoot = new Object();

        private HistoryOSRepositoryMock() { }

        public static HistoryOSRepositoryMock Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new HistoryOSRepositoryMock();
                            instance.Initialize();
                        }
                    }
                }
