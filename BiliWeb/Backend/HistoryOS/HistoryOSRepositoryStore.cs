...
{
    /// <summary>
    /// In Memory Implementation of a HistoryOS data store
    /// </summary>
    public class HistoryOSRepositoryStore : IHistoryOSRepository
    {
        #region Singleton
        /// <summary>
        /// Make into a Singleton
        /// </summary>
        private static volatile HistoryOSRepositoryStore instance;
        private static readonly object syncRoot = new Object();

        private HistoryOSRepositoryStore() { }

        public static HistoryOSRepositoryStore Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new HistoryOSRepositoryStore();
                            instance.Initialize();
                        }
                    }
                }
        ...
        private List<HistoryOSModel> dataset = new List<HistoryOSModel>();
        private string dataSourceString = "Store";

        public const string ClassName = "HistoryOSModel";
        ...
        public HistoryOSModel Read(string id)
        {
        ...
        public bool Delete(string Id, DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            ...
            // Storage Delete
            var myReturn = DataSourceBackendTable.Instance.Delete<HistoryOSModel>(tableName, partitionKey, Id, dataSourceEnum);
        ...
        public List<HistoryOSModel> Index()
        {
            return dataset;
        }
        ...
        /// <returns></returns>
        public List<HistoryOSModel> LoadAll(DataSourceEnum dataSourceEnum = DataSourceEnum.Unknown)
        {
            var DataSetList = DataSourceBackendTable.Instance.LoadAll<HistoryOSModel>(tableName, partitionKey, true, dataSourceEnum);
        ...
        {
            var dataSet = HistoryOSRepositoryDataHelper.Instance.GetDefaultDataSet();
...
public HistoryOSModel Create(HistoryOSModel data)
        {
            if (data == null)
            {
                return null;
        ...
        /// <summary>
        /// Return the requested HistoryOS item from the data store
